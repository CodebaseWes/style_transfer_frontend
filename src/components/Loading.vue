<template>
    <div>
        <h1>Loading...</h1>
        <h3>This may take several seconds.</h3>
        <h3 v-if="shortWait">Enjoy some pancakes in the meantime!</h3>
        <h3 v-else>My robot artist is waking up... it won't take as long next time... sit tight!</h3>
      </div>
    <div class="loader">
