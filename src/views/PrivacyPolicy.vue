...
<template>
  <div id="PrivacyContainer">
    <div  id="Privacy">
      ...
      <p>{{SiteName}} does not knowingly collect personally identifiable information. Images are uploaded to an API maintained by {{SiteName}}. 
        These images are passed as inputs to a Deep Learning algorithm that returns another image as output. The security of the back-end servers is the responsibility
        of this site's hosting provider, Amazon Web Services. The content of the images uploaded to the site is at the discretion of the end-user. 
        {{SiteName}} does not take responsibility for damages incurred by end-users uploading images that contain personally identifiable or sensitive information.
      </p>
      ...
      <p>{{SiteName}} does not knowingly collect any Personal Identifiable Information from children under the age of 13. </p>

      <h2>Online Privacy Policy Only</h2>

      <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in {{SiteName}}. This policy is not applicable to any information collected offline or via channels other than this website.</p>

      <h1>Website Terms of Use</h1>

  <p>Version 1.0</p>

  <p>The {{SiteName}} website located at {{url}} is a copyrighted work belonging to {{SiteName}}. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
  ...
  <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: no address. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
  ...
  <p><strong>Small Claims Court.</strong> Nonetheless the foregoing, either you or the Company may bring an individual action in small claims court.</p>
    ...
    <p>By using our website, you hereby consent to our Privacy Policy and agree to its Terms and Conditions. {{SiteName}} reserves the right to modify this policy whenever we see fit.</p>
  </div>    
</div>
</template>
<script>
